...
//	U8_T uart_WordLen[3];
	...
	U8_T fix_com_config;  // 0 - default, com port can be changed, 1 - com port is fixed
	U8_T write_flash;   // 0 - default, dont use it for ARM version.
	}reg;
}Str_Setting_Info;
...
#if 0
extern U8_T Send_bip_Flag_COV;
extern U8_T far Send_bip_address_COV[6];
extern U8_T far Send_bip_count_COV;

extern U8_T Send_bip_Flag_BBMD;
extern U8_T far Send_bip_address_BBMD[6];
extern U8_T far Send_bip_count_BBMD;
#endif
...
extern Str_grp_element_new			far	    		 group_data_new;
...
extern long			 far   					arrays_data[MAX_ARRAYS_DATA];
...
extern REMOTE_POINTS		  far  		 remote_points_list[MAXREMOTEPOINTS];
...
extern POINTS_HEADER		  far  		 local_points_list[MAXLOCALPOINTS];
extern Byte                far			 number_of_local_points;

extern U16_T 	Last_Contact_Network_points[MAXNETWORKPOINTS];
extern U16_T 	Last_Contact_Remote_points[MAXREMOTEPOINTS];
extern U16_T 	Last_Contact_Local_points[MAXLOCALPOINTS];
...
extern uint8_t count_modbus_slave[3];
