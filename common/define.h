...
#else  // TSTAT10
#define HI_COMMON_CHANNEL  12  // 8(UI) + 4(HSP counter)  T3-OEM
#define HI_COMMON_CHANNEL2	16  // 12 UI + 4 HSP counter T3-OEM_12IN
...
extern U16_T new_slop[2][10];
extern U16_T new_start_adc[2][11];
extern U16_T new_vcc_adc[3];
...
#elif ARM_TSTAT_WIFI
extern U8_T far flag_count_in[HI_COMMON_CHANNEL + 4];	
extern U32_T far high_spd_counter[HI_COMMON_CHANNEL + 4];
extern U32_T far high_spd_counter_tempbuf[HI_COMMON_CHANNEL + 4];
extern U8_T far high_spd_en[HI_COMMON_CHANNEL + 4];
extern U32_T far Input_RPM[HI_COMMON_CHANNEL + 4];
#endif
typedef	union
{
	unsigned int  word;
...
extern U16_T count_write_Flash;
...
extern uint16_t count_start_task;
extern uint8_t shutdown_Time;
extern uint8_t shutdown_runtime;
extern bool Send_shutdown_Flag;
extern int count_update_mstp_db;
extern uint8_t upate_mstp_flag;
extern uint32_t shutdown_start_time;
extern uint32_t shutdown_send_time;
...
extern U8_T flag_change_realy;
extern U8_T last_relay_status;
extern U8_T count_change_relay;
...
//	EEP_PORT_HIGH,
	...
	EEP_TEST1,
	EEP_SUSPEND_MSTP,  // bit7: -> flag_suspend_mstp
	EEP_T10_ICON_CONFIG,
	
	//EEP_UART0_WORDLEN,
	//EEP_UART1_WORDLEN,
	//EEP_UART2_WORDLEN,// 237
	
	EEP_SYNC_UDP_SCAN_SEND_LPORT, // 235
	...
	EEP_FLASH_MAC = 254,	
	//MAX_EEP_CONSTRANGE = 255,  // OLD 24C02


	EEP_OUT_1V_2,
	EEP_OUT_2V_2 = EEP_OUT_1V_2 + 2,
	EEP_OUT_3V_2 = EEP_OUT_1V_2 + 4,
	EEP_OUT_4V_2 = EEP_OUT_1V_2 + 6,
	EEP_OUT_5V_2 = EEP_OUT_1V_2 + 8,
	EEP_OUT_6V_2 = EEP_OUT_1V_2 + 10,
	EEP_OUT_7V_2 = EEP_OUT_1V_2 + 12,
	EEP_OUT_8V_2 = EEP_OUT_1V_2 + 14,
	EEP_OUT_9V_2 = EEP_OUT_1V_2 + 16,
	EEP_OUT_10V_2 = EEP_OUT_1V_2 + 18,
	
	EEP_OUT_1V_3 = EEP_OUT_10V_2 + 2,
	EEP_OUT_2V_3 = EEP_OUT_1V_3 + 2,
	EEP_OUT_3V_3 = EEP_OUT_1V_3 + 4,
	EEP_OUT_4V_3 = EEP_OUT_1V_3 + 6,
	EEP_OUT_5V_3 = EEP_OUT_1V_3 + 8,
	EEP_OUT_6V_3 = EEP_OUT_1V_3 + 10,
	EEP_OUT_7V_3 = EEP_OUT_1V_3 + 12,
	EEP_OUT_8V_3 = EEP_OUT_1V_3 + 14,
	EEP_OUT_9V_3 = EEP_OUT_1V_3 + 16,
	EEP_OUT_10V_3 = EEP_OUT_1V_3 + 18,
	
	EEP_NEW_VCC_ADC1 = EEP_OUT_10V_3 + 2,
	EEP_NEW_VCC_ADC2 = EEP_NEW_VCC_ADC1 + 2,
	EEP_NEW_VCC_ADC3 = EEP_NEW_VCC_ADC2 + 2,
#if SAVE_LOCAL_VAR_TO_E2	
	EEP_LOCAL_VAR_BASE = EEP_NEW_VCC_ADC3 + 2, // ONLY PLC
#endif
	MAX_EEP_CONSTRANGE = 2024,  // OLD 24C16
}E_EEP;
...
//	MODBUS_NETWORK_UART2,
	...
	MODBUS_INPUT_MOUDLE = 54,  // 54 --> 0 is without pt, 1 is with PT sensor
	MODBUS_TOP_FW,
	MODBUS_TOP_HW,
  ...
  MODBUS_COM0_TYPE = 59,
	...
	MODBUS_REFRESH_FLASH = 92, // WRITE FLASH
...
//	MODUBS_BAC_LIB_REV,
  ...
  MODBUS_MAC_1 = 100,
	...
	MODBUS_TCP_LISTEN_PORT = 120,	

//	MODBUS_GSM_IP_1, // no used
//	MODBUS_GSM_IP_2, // no used
//	MODBUS_GSM_IP_3, // no used
//	MODBUS_GSM_IP_4, // no used
//	MODBUS_GSM_TCPPORT, // no used
//	MODBUS_GSM_SEVER_OR_CLIENT,// no used
//	MODBUS_GSM_UDPPORT,
...
//	MODBUS_GSM_UDP_LINKID,
  ...
  MODBUS_UART0_PARITY = 150,  // UART0 parity
	...
	MODBUS_UART0_WORDLEN = 156,  // UART0 WORDLEN
	MODBUS_UART1_WORDLEN = 157,  // UART1 WORDLEN	
	MODBUS_UART2_WORDLEN = 158,	// UART2 WORDLEN
