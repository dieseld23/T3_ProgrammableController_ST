...
//------------------------------------------------------------------------------
// Reset on port D, bit 3
#define RESET_LOW()  (GPIOD->BSRR = 0x10000000) // set Reset to low
#define RESET_HIGH() (GPIOD->BSRR = 0x00001000) // set Reset to high
...
//==============================================================================
etError SHT3X_Read2BytesAndCrc(uint16 *dat, etI2cAck finaleAckNack, uint8 timeout){
//==============================================================================
  etError error;    // error code
  ...
  *dat = (bytes[0] << 8) | bytes[1];
  
  return error;
}

//==============================================================================
etError SHT3X_Write2BytesAndCrc(uint16 dat){
//==============================================================================
  etError error;    // error code
  uint8     bytes[2]; // read data array
  uint8     checksum; // checksum byte
...
//==============================================================================
uint8 SHT3X_CalcCrc(uint8 dat[], uint8 nbrOfBytes){
//==============================================================================
...
//==============================================================================
etError SHT3X_CheckCrc(uint8 dat[], uint8 nbrOfBytes, uint8 checksum){
//==============================================================================
  uint8 crc;     // calculated checksum
  
	// calculates 8-Bit checksum
	crc = SHT3X_CalcCrc(dat, nbrOfBytes);
