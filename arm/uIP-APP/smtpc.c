...
S8_T far smtpc_Buf[256];
U8_T far smtpc_rcv_Buf[200];
U8_T far smtpc_Subject[50];
char far smtpc_Context[100];
...
//			goto sendquit;
	...
	uart1_init(115200);
	DEBUG_EN = 1;
	printf("user encode :%s,%s\n",Email_Setting.reg.user_name,smtpc_Buf);	
#endif			
...
senddata:
	...
	{
sendquit:
		Email_Setting.reg.error_code = smtpc_Conns.State;
		smtpc_Buf[0] = 'Q';
		smtpc_Buf[1] = 'U';
		smtpc_Buf[2] = 'I';
		smtpc_Buf[3] = 'T';
...
//	
//	memcpy(Email_Setting.reg.user_name,"57440569@qq.com",36);
//	memcpy(Email_Setting.reg.To1Addr,"chelsea@temcocontrols.com",36);
//	memcpy(Email_Setting.reg.To2Addr,"57440569@qq.com",36);
	//memcpy(To3Addr,"fandu@temcocontrols.com",36);
	
	// check Email_Setting.reg.smtp_domain 
	if (strlen(Email_Setting.reg.smtp_domain) >= 32) { 
    //printf("Error: smtp_domain is too long\n");		
    return;
	}
	resolv_query(Email_Setting.reg.smtp_domain);

//	memcpy(Email_Setting.reg.smtp_domain,"localhost",36);
//	memcpy(Email_Setting.reg.user_name,"chelsea@temcocontrols.com",36);
//	memcpy(Email_Setting.reg.password,"u6flh?lO",36);
//	memcpy(Email_Setting.reg.To1Addr,"chelsea@temcocontrols.com",36);
//	memcpy(Email_Setting.reg.To2Addr,"57440569@qq.com",36);
...
//	
	...
	{
		flag_sendemail = 0;
		memcpy(smtpc_Conns.From,Email_Setting.reg.email_address,50);
		memcpy(smtpc_Conns.To1,Email_Setting.reg.To1Addr,50);
		memcpy(smtpc_Conns.To2,Email_Setting.reg.To2Addr,50);
		//memcpy(smtpc_Conns.To3,"",50);
#if ARM_UART_DEBUG
	uart1_init(115200);
	DEBUG_EN = 1;
	...
	printf("email_address :%s\n",Email_Setting.reg.email_address);	
	printf("password :%s\n",Email_Setting.reg.password);	
	printf("To1Addr :%s\n",Email_Setting.reg.To1Addr);
	printf("To2Addr :%s\n",Email_Setting.reg.To2Addr);
#endif		
